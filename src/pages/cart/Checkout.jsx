...
const Checkout = () => {
  ...
  return (
    <div className="mb-10 px-5 md:px-[160px]">
      {/* Breadcum Section */}
      <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row">
        <p className="text-2xl font-bold text-gray-800">Chairs</p>
        {/* Breadcum */}
      ...
      <div className="grid lg:grid-cols-2">
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
          ...
          <button  className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white disabled:cursor-not-allowed disabled:bg-gray-700" disabled={products?.length <= 0}>
            Place Order
          </button>
